# Contributing
This is a general contribution guide for all of the [VineJS](https://github.com/vinejs) repos. Please read this guide thoroughly before contributing to any of the repos 🙏
...
If you have written a blog post, created a package for VineJS, or presented us in a Confrence/Meetup, feel free to [share your work with us](https://github.com/vinejs/vine/issues/6).

## Creating pull requests
It is never a good experience to have your pull request declined after investing a lot of time and effort in writing the code. Therefore, we highly recommend you to [kick off a discussion](https://github.com/vinejs/vine/issues/new?title=Discussion%20for%20a%20new%20feature%20-%20%3CYOUR%20FEATURE%20NAME%3E) before starting any new work on your side.
